...
export const jsonData: GameData = [
  {
    "id": "0",
    "mensagem": "O pó das cinzas do que um dia foi um corpo pequeno e frágil se esvaiu pela vila silenciosa, passando pelas paredes que uma vez confidenciou fofocas e brincadeiras das crianças. [IMAGEM] Acho que posso estar um pouco distraído...\nEsquecendo de respirar...\nOs ventos violentos que tornou tudo ao seu redor pó, incluindo a sua própria filha Felícia agora o saudava como um rei. Mas tudo isso era sem sentido, o mundo pulsava assim como suas emoções que o levavam a querer destruir tudo, mas em sua mente uma sobriedade sem limites imperava... uma vontade que era maior do que ele mesmo se acomodava e reformava a sua vontade. Sin... um bom nome e adequado, natural como sua respiração que respondia ao pulsar do mundo e as emoções de seu corpo. Olhando ao redor era claro que o colapso nervoso de alguém destruiu toda a vila Naríbia, um som final do mundo o chamava para se tornar um com ele, mas o chão aos seus pés pulsava como correntes que o empurravam para outro local.",
  ...
  {
    "id": "7",
    "mensagem": "Você mantém o laço de cabelo consigo — a dor ainda é parte de quem você é. [IMAGEM] A cidade de Abenra pulsa ao seu redor, mas a lembrança de Felícia e Naríbia permanece viva em seu peito. Você sabe que a busca por um propósito ou uma nova vida não será fácil com esse fardo. O que fará agora?",
    "imagem_url": "/assets/id.png",
    "possiveis_destinos": [
      {
  ...
  {
    "id": "92",
    "mensagem": "Sin olhou para a bifurcação como quem encara dois espelhos: um refletia sua dor; o outro, o silêncio após ela. Ele se virou devagar, afastando-se da torre. O caminho da esquerda era de grama alta, colinas suaves e ventos sem memórias. [IMAGEM] A terra não sabia seu nome. E talvez fosse isso que ele buscava. A estrada foi engolindo seus passos. As nuvens, antes pesadas, tornaram-se lençóis brancos, sem forma. O mundo já não pulsava como antes. Nem o seu coração. Ele não deixou uma lápide. Não contou sua história. Não pediu perdão. Apenas sumiu. Alguns aldeões juram ter visto um homem calado que ajuda na colheita, que dorme sob árvores e sorri pouco, mas sinceramente. Um homem sem nome. Um homem que não sonha — ou sonha com coisas que não sabe de onde vêm. Felícia... talvez seja apenas o nome de uma flor, agora.",
